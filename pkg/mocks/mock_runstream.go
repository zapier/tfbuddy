...
// Source: pkg/runstream/interfaces.go
//
// Generated by this command:
//
//	mockgen -source pkg/runstream/interfaces.go -destination pkg/mocks/mock_runstream.go -package mocks github.com/zapier/tfbuddy/pkg/runstream
//
...
// FinalizeAutoMerge mocks base method.
func (m *MockStreamClient) FinalizeAutoMerge(ref runstream.AutoMergeRef, merged bool) (runstream.AutoMergeResult, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FinalizeAutoMerge", ref, merged)
	ret0, _ := ret[0].(runstream.AutoMergeResult)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// FinalizeAutoMerge indicates an expected call of FinalizeAutoMerge.
func (mr *MockStreamClientMockRecorder) FinalizeAutoMerge(ref, merged any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FinalizeAutoMerge", reflect.TypeOf((*MockStreamClient)(nil).FinalizeAutoMerge), ref, merged)
}
...
// RecordAutoMergeRequested mocks base method.
func (m *MockStreamClient) RecordAutoMergeRequested(ref runstream.AutoMergeRef) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecordAutoMergeRequested", ref)
	ret0, _ := ret[0].(error)
	return ret0
}

// RecordAutoMergeRequested indicates an expected call of RecordAutoMergeRequested.
func (mr *MockStreamClientMockRecorder) RecordAutoMergeRequested(ref any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecordAutoMergeRequested", reflect.TypeOf((*MockStreamClient)(nil).RecordAutoMergeRequested), ref)
}
...
func (m *MockRunMetadata) GetAutoMerge() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAutoMerge")
	ret0, _ := ret[0].(bool)
	return ret0
}
